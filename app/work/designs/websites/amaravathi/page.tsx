...
const websiteScreens = [
  {
    src: '/images/designs/websites/screengrabs/amaravathi/amaravathi-1.jpg',
    alt: 'Hotel Amaravathi Homepage',
    title: 'Homepage',
    description: 'Elegant homepage showcasing the hotel amenities and booking options',
  },
  {
    src: '/images/designs/websites/screengrabs/amaravathi/amaravathi-2.jpg',
...
export default function AmaravathiWebsitePage() {
        ...
        <div className="container-content">
          ...
          <ScrollReveal delay={0.1}>
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="px-4 py-1 bg-amber-600/20 text-amber-400 rounded-full text-sm font-medium">
                Website Design
              </span>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.3}>
            <p className="text-xl text-warm-gray max-w-3xl mb-8">
              A sophisticated hospitality website designed for Hotel Amaravathi.
              Elegant design with seamless booking integration and beautiful imagery to showcase the hotel experience.
            </p>
          </ScrollReveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <ScrollReveal>
              <div className="text-center">
                ...
                <p className="text-white text-xl font-semibold">Hotel Amaravathi</p>
              </div>
            </ScrollReveal>
            <ScrollReveal delay={0.1}>
              <div className="text-center">
                <h3 className="text-primary-red font-mono text-sm uppercase tracking-wider mb-2">Industry</h3>
                <p className="text-white text-xl font-semibold">Hospitality</p>
              </div>
            </ScrollReveal>
            <ScrollReveal delay={0.2}>
              <div className="text-center">
