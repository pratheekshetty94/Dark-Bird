...
import { Video, Palette, ImageIcon } from 'lucide-react'
...
const socialReels = [
  { client: 'GK Builders & Developers', title: 'Investor Spotlight', src: '/images/socials/brand-campaigns/reels/investor-video.mp4' },
  { client: 'GK Builders & Developers', title: "A Dog's Hope", src: '/images/socials/brand-campaigns/reels/dogs-hope.mp4' },
  { client: 'GK Builders & Developers', title: 'Celebrities Together', src: '/images/socials/brand-campaigns/reels/celebrities-together.mp4' },
  { client: 'GK Builders & Developers', title: 'Anjani Lake Woods Launch', src: '/images/socials/brand-campaigns/reels/anjani-launch.mp4' },
  { client: 'GK Builders & Developers', title: '2025 Year in Review', src: '/images/socials/brand-campaigns/reels/2025-wrap-up.mp4' },
  { client: 'GK Builders & Developers', title: 'Republic Day', src: '/images/socials/brand-campaigns/reels/republic-day.mp4' },
  { client: 'GK Builders & Developers', title: 'Nature Meets AI', src: '/images/socials/brand-campaigns/reels/nature-ai.mp4' },
  { client: 'GK Builders & Developers', title: 'Collect Things', src: '/images/socials/brand-campaigns/reels/collect-things.mp4' },
  { client: 'GK Builders & Developers', title: 'Why Not Now', src: '/images/socials/brand-campaigns/reels/why-not-now.mp4' },
  { client: 'GK Builders & Developers', title: 'Kannada Rajyotsava', src: '/images/socials/brand-campaigns/reels/kannada-rajyotsava.mp4' },
  { client: 'GK Builders & Developers', title: 'Christmas', src: '/images/socials/brand-campaigns/reels/christmas.mp4' },
  { client: 'GK Builders & Developers', title: 'Hill View Countdown', src: '/images/socials/brand-campaigns/reels/hillview-countdown.mp4' },
  { client: 'GK Builders & Developers', title: 'Hill View Launch', src: '/images/socials/brand-campaigns/reels/hillview-launch.mp4' },
  { client: 'GK Builders & Developers', title: 'Move Your Thumb', src: '/images/socials/brand-campaigns/reels/move-your-thumb.mp4' },
  { client: 'GK Builders & Developers', title: 'Deepavali', src: '/images/socials/brand-campaigns/reels/deepavali.mp4' },
  { client: 'GK Builders & Developers', title: 'Kids', src: '/images/socials/brand-campaigns/reels/kids.mp4' },
  { client: 'GK Builders & Developers', title: 'Intro Board', src: '/images/socials/brand-campaigns/reels/intro-board.mp4' },
  { client: 'GK Builders & Developers', title: 'Gandhi Jayanti', src: '/images/socials/brand-campaigns/reels/gandhi-jayanti.mp4' },
  { client: 'GK Builders & Developers', title: 'Car Parking', src: '/images/socials/brand-campaigns/reels/car-parking.mp4' },
  { client: 'GK Builders & Developers', title: 'Dussehra', src: '/images/socials/brand-campaigns/reels/dusshera.mp4' },
  { client: 'GK Builders & Developers', title: 'National Youth Day', src: '/images/socials/brand-campaigns/reels/national-youth-day.mp4' },
  { client: 'GK Builders & Developers', title: 'Sankranti', src: '/images/socials/brand-campaigns/reels/sankranti.mp4' },
]

const brandingLogos = [
  { name: 'Ashi', src: '/images/designs/logos/ashi.jpg' },
  { name: 'Bake A Luru', src: '/images/designs/logos/bake-a-luru.jpg' },
  { name: 'Great Indian Salon', src: '/images/designs/logos/great-indian-salon.jpg' },
  { name: 'Lorem Picsome', src: '/images/designs/logos/lorem-picsome.png' },
  { name: 'Vanas', src: '/images/designs/logos/vanas.png' },
]
...
export default function BrandCampaignsSection() {
  return (
    <>
      {/* Section header + walkthrough films */}
      <section id="brand-campaigns" className="section-light section-padding scroll-mt-24">
        <div className="container-content">
          <ScrollReveal>
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="px-4 py-1 bg-purple-600/20 text-purple-600 rounded-full text-sm font-medium">
                Brand Campaigns
              </span>
            </div>
          </ScrollReveal>
      ...
      {/* Social Media Reels */}
      <section id="reels" className="section-dark section-padding scroll-mt-24">
        <div className="container-content">
          <ScrollReveal>
            <h2 className="text-2xl font-bold text-white mb-2">Social Media Reels</h2>
      ...
      {/* Social Media Posts */}
      <section id="posts" className="section-light section-padding scroll-mt-24">
        <div className="container-content">
          <ScrollReveal>
      ...
      <section id="branding" className="section-dark section-padding scroll-mt-24">
        <div className="container-content">
          <ScrollReveal>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white">Branding & Logo Design</h2>
